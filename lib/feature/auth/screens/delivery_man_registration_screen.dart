...
import 'package:BUNAB_Delivery_Driver/feature/auth/widgets/additional_data_section_widget.dart';
import 'package:BUNAB_Delivery_Driver/feature/auth/widgets/pass_view_widget.dart';
...
import 'package:BUNAB_Delivery_Driver/feature/auth/domain/models/delivery_man_body_model.dart';
    ...
    if(authController.dmStatus == 0.4) {
      ...
      if(authController.dmTypeIndex == -1) {
        ...
        data.addAll(DeliveryManBodyModel(
          ...
          earning: authController.dmTypeIndex == 1 ? '1' : '0', zoneId: addressController.zoneList![addressController.selectedZoneIndex!].id.toString(),
